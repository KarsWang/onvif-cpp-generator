...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.132 2024-02-21 05:20:06 GMT")
...
{	(void)tag;
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in ws_discovery\\soapC.cpp\n", tag ? tag : "", type));
